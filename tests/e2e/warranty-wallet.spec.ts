 ...
 *
 * WW.1  Pro tier with no warranty jobs → empty state
 * WW.2  Pro tier with warranty jobs → heading + all three sections
 * WW.3  Pro tier → scan-document panel visible
 */
...
test.describe("WW.1 — /warranties (Pro, no warranties)", () => {
...
test.describe("WW.2 — /warranties (Pro, with warranty jobs)", () => {

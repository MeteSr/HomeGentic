...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>Because Your Content is stored on the Internet Computer Protocol blockchain, it is replicated across decentralized nodes and cannot be fully erased from the protocol's history. See our <Link to="/privacy" style={{ color: C.blue }}>Privacy Policy</Link> for details.</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p style={{ fontFamily: F.mono, fontSize: "0.8rem", lineHeight: 1.8 }}>
          HomeGentic, Inc. — DMCA Agent<br />
          <a href="mailto:dmca@homegentic.app" style={{ color: C.blue }}>dmca@homegentic.app</a>
        </p>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>Before filing any legal action, you agree to first contact us at <a href="mailto:legal@homegentic.app" style={{ color: C.blue }}>legal@homegentic.app</a> and attempt to resolve the dispute informally for at least 30 days.</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    title: "Contact Us",
    body: (
      <p>HomeGentic, Inc. · <a href="mailto:legal@homegentic.app" style={{ color: C.blue }}>legal@homegentic.app</a> · For support inquiries, visit our <Link to="/support" style={{ color: C.blue }}>Support page</Link>. For privacy questions, see our <Link to="/privacy" style={{ color: C.blue }}>Privacy Policy</Link>.</p>
    ),
  },
];
